...
public class SettingPresenter extends BasePresenter<SettingView> {
    ...
    public void onDestroy() {
        super.onDestroy();
        if (mSettingSubscription != null && !mSettingSubscription.isUnsubscribed()) {
            mSettingSubscription.unsubscribe();
        }

    }


    private Observer<AbsReturn<DefaultData>> SettingObserver = new EndObserver<AbsReturn<DefaultData>>() {
        @Override
        public void onEnd() {
            if (getBaseView() != null) {
