 ...
 */
public class FourNumberPickerDialog {
    ...
    public FourNumberPickerDialog(Context context,String[] listShow,String[] listShow1,String[] listShow2, PickListen pickListen) {
    ...
    public void init() {
        ...
        al.show();
        window = al.getWindow();
        window.setContentView(R.layout.pickdialog_four);
    ...
    public void showDialog() {
        ...
        dataInfo = MyList[0];
        np1.setDisplayedValues(MyList);
        np1.setMaxValue(MyList.length - 1);
        np1.setMinValue(0);
        np1.setValue(0);
