...
public class HomeModel {
    ...
    public Observable<AbsReturn<ArrayList<HomeMenuEntity>>> getHomeMenu(){
        return mService.getApi().getHomeMenu(SharedPreferencesUtil.getInstance(App.getInstance()).getString("session")).compose(schedulerProvider.applySchedulers());
    }
}