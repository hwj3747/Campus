...
public class AttendanceInfoModel {
    ...
    public Observable<AbsReturn<ArrayList<AttendanceInfoEntity>>> getAttendanceInfo(String weekNum,String lessonId){
        return mService.getApi().getAttendanceInfo(weekNum,lessonId, SharedPreferencesUtil.getInstance(App.getInstance()).getString("session")).compose(schedulerProvider.applySchedulers());
    }
}