...
public class HomeworkModel {
    ...
    public Observable<AbsReturn<ArrayList<HomeworkEntity>>> getHomeWork(String weekNum){
        return mService.getApi().getHomework(weekNum, SharedPreferencesUtil.getInstance(App.getInstance()).getString("session")).compose(schedulerProvider.applySchedulers());
    }
}