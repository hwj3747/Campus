...
public class ScoreModel {
    ...
    public Observable<AbsReturn<ConditionResultEntity>> getCondition(){
        return  mService.getApi().getCondition(SharedPreferencesUtil.getInstance(App.getInstance()).getString("session")).compose(schedulerProvider.applySchedulers());
    }
}