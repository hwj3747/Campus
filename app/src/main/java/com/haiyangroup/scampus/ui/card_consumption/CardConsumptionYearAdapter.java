 ...
 */
public class CardConsumptionYearAdapter extends BaseAdapter {

    private LayoutInflater mInflater;
    private ArrayList<CardConsumptionEntity> mData;
    private Context mContext;

    public CardConsumptionYearAdapter(Context context, ArrayList<CardConsumptionEntity> data) {
        mContext = context;
        mData = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_card_consumption_year, null);
