...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected String headSend;
    protected String headReceive;
    ...
    public EaseChatRow(Context context, String headSend,String headReceive,EMMessage message, int position, BaseAdapter adapter) {
        super(context);
        this.context = context;
        this.activity = (Activity) context;
        this.headReceive=headReceive;
